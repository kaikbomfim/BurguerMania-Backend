    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Sabor incrível sem abrir mão do veganismo. O hambúrguer perfeito para quem ama comer bem e com consciência!", "X-Vegan", "http://localhost:5190/public/assets/burguer.png" },
                    { 2, "Leve, saudável e delicioso! O hambúrguer ideal para quem busca equilíbrio e sabor na mesma mordida.", "X-Fitness", "http://localhost:5190/public/assets/burguer.png" },
                    { 3, "Para os corajosos e amantes de um hambúrguer generoso! Cada mordida é uma explosão de sabor.", "X-Infarto", "http://localhost:5190/public/assets/burguer.png" }
                });
